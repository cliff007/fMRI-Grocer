function FG_norm_write_mean_allSmoothedFun_gen
...
anyreturn=FG_modules_selection('','','','^sr.*img$|^sr.*nii$','r','g','fo','fi','me','sn');
if anyreturn, return;end

for g=1:size(groups,1)
    write_name=FG_check_and_rename_existed_file(['norm_write_mean_allSmoothed_'  deblank(groups(g,:))  '_job.m'])    
