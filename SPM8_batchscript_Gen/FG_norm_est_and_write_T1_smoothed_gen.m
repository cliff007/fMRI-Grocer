function FG_norm_est_and_write_T1_smoothed_gen
...
anyreturn=FG_modules_selection('','','','^sr.*img$|^sr.*nii$','r','g','fo','fi','t');
...
for g=1:size(groups,1)
    write_name=FG_check_and_rename_existed_file(['norm_est_write_T1_Smoohted_'  deblank(groups(g,:))  '_job.m'])      
