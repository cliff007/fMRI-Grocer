function [num, den, z, p] = FG_fltbutter_filter(n, Wn, varargin)
...
[btype,analog,errStr] = FG_para_check_fltiirchk(Wn,varargin{:});
error(errStr)
...
if btype == 1		% Lowpass
	[a,b,c,d] = FG_fltlp2lp(a,b,c,d,Wn);

elseif btype == 2	% Bandpass
	[a,b,c,d] = FG_fltlp2bp(a,b,c,d,Wn,Bw);

elseif btype == 3	% Highpass
	[a,b,c,d] = FG_fltlp2hp(a,b,c,d,Wn);

elseif btype == 4	% Bandstop
	[a,b,c,d] = FG_fltlp2bs(a,b,c,d,Wn,Bw);
end

% step 5: Use Bilinear transformation to find discrete equivalent:
if ~analog,
	[a,b,c,d] = FG_fltbilinear(a,b,c,d,fs);
end
