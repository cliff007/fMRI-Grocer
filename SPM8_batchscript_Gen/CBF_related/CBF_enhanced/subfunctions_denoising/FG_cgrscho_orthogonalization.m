function A = FG_cgrscho_orthogonalization(A)
...
% could also form simply an orthogonal basis. 
% The key ingredient of this procedure is that each new orthonormal basis 
% vector is obtained by subtracting out the projection of the next linearly 
% independent vector onto the vectors accepted so far into the set. 
% We may say that each new
...
% The method is named for J�rgen Pedersen Gram (a Danish actuary) and Erhard
