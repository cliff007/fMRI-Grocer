function [r, p, LB, UB, F, df1, df2] = FG_ICC(M, type, alpha, r0)
% Intraclass correlation
%   [r, p, LB, UB, F, df1, df2] = ICC(M, type, alpha, r0)
%
...
if nargout>2
    ...
    switch type
        case '1-1'
            [r, p, LB, UB, F, df1, df2] = ICC_case_1_1(MSR, MSE, MSC, MSW, alpha, r0, n, k);
        case '1-k'
            [r, p, LB, UB, F, df1, df2] = ICC_case_1_k(MSR, MSE, MSC, MSW, alpha, r0, n, k);
        case 'C-1'
            [r, p, LB, UB, F, df1, df2] = ICC_case_C_1(MSR, MSE, MSC, MSW, alpha, r0, n, k);
        case 'C-k'
            [r, p, LB, UB, F, df1, df2] = ICC_case_C_k(MSR, MSE, MSC, MSW, alpha, r0, n, k);
        case 'A-1'
            [r, p, LB, UB, F, df1, df2] = ICC_case_A_1(MSR, MSE, MSC, MSW, alpha, r0, n, k);
        case 'A-k'
            [r, p, LB, UB, F, df1, df2] = ICC_case_A_k(MSR, MSE, MSC, MSW, alpha, r0, n, k);
    end
...
elseif nargout==2
    ...
    switch type
        case '1-1'
            [r, p] = ICC_case_1_1(MSR, MSE, MSC, MSW, alpha, r0, n, k);
        case '1-k'
            [r, p] = ICC_case_1_k(MSR, MSE, MSC, MSW, alpha, r0, n, k);
        case 'C-1'
            [r, p] = ICC_case_C_1(MSR, MSE, MSC, MSW, alpha, r0, n, k);
        case 'C-k'
            [r, p] = ICC_case_C_k(MSR, MSE, MSC, MSW, alpha, r0, n, k);
        case 'A-1'
            [r, p] = ICC_case_A_1(MSR, MSE, MSC, MSW, alpha, r0, n, k);
        case 'A-k'
            [r, p] = ICC_case_A_k(MSR, MSE, MSC, MSW, alpha, r0, n, k);
    end    
...
%----------------------------------------
function [r, p, LB, UB, F, df1, df2] = ICC_case_1_1(MSR, MSE, MSC, MSW, alpha, r0, n, k)
...
%----------------------------------------
function [r, p, LB, UB, F, df1, df2] = ICC_case_1_k(MSR, MSE, MSC, MSW, alpha, r0, n, k)
r = (MSR - MSW) / MSR;
...
%----------------------------------------
function [r, p, LB, UB, F, df1, df2] = ICC_case_C_1(MSR, MSE, MSC, MSW, alpha, r0, n, k)
...
%----------------------------------------
function [r, p, LB, UB, F, df1, df2] = ICC_case_C_k(MSR, MSE, MSC, MSW, alpha, r0, n, k)
r = (MSR - MSE) / MSR;
...
%----------------------------------------
function [r, p, LB, UB, F, df1, df2] = ICC_case_A_1(MSR, MSE, MSC, MSW, alpha, r0, n, k)
...
%----------------------------------------
function [r, p, LB, UB, F, df1, df2] = ICC_case_A_k(MSR, MSE, MSC, MSW, alpha, r0, n, k)
