 function  TC=FG_get_meanCBF_TC_in_ROIs_singlesubDir_CMD(Filename,brain,ROIs,Val_range_low,Val_range_up)
 % TC=FG_get_meanCBF_TC_in_ROIs_singlesubDir_CMD(Filename,[],ROIs,0,100)
    if nargin==0
         %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
         % files selcet   % start 
         %%%%%%%%%%%%%%%%%%%%%%%%%%%%%
         ...
         %%%%%%%%%%%%%%%%%%%%%%%%%%%%%
          ...
          n_ROI=size(ROIs,1);
          n_Img=size(Filename,1);
          Val_range={num2str(Val_range_low);num2str(Val_range_up)};          
    end
