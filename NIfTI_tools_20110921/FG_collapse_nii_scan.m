...
%
function FG_collapse_nii_scan(scan_pattern, fileprefix, scan_path)
   ...
   fileprefix=[fileprefix,'_',num2str(size(flist,1))] ; % redefine the file name
   
   nii = FG_load_untouch_nii(flist{1});
   ...
   for i = 1:length(flist)
      nii = FG_load_untouch_nii(flist{i});
