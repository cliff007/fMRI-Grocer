function [] = FG_rest_writefile(data,filename,isize,vsize,Header,dtype)
...
%   Last Revised by YAN Chao-Gan, 100225. Check if vsize is a 1 by 3 array.
%-----------------------------------------------------------
...
if isfield(Header,'mat')
    ...
    Header.dim   =isize;
    Header.pinfo = [1;0;0];
    FG_rest_WriteNiftiImage(data,Header,filename);
else
    ...
    FG_rest_WriteAnalyzeImage(data,filename,isize,vsize,Header.Origin,dtype);
end
