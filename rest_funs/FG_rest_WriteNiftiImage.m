...
%     cd(oldDir);
   ...
   flag=0;% fail
%    cd(oldDir);
   error('Meet error while writing data. 1) Please ensure there is NO space or Chinese character in the file path; Or 2) Please restart MATLAB, and run "FG_rest_Fix_Read_Write_Error" before starting REST.');
end
