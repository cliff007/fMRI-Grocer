function FG_image_quality_evaluation_ASL(fun_imgs,write_name)
...
% get and check the motion parameters of a series of images
    ...
    saveas(gcf,fullfile(root_first,'1_Snap_motion.jpg'))
...
%                 saveas(gcf,fullfile(root_first,'3_Snap_artifact_ROI_timecourses.jpg'))   
%                 if nargin~=0, close (gcf); end
%                 pause(0.01)  % release the memory to close the figure
% 
...
%                 Rs_of_Artifact_ROIs=FG_set_half_diagonal_matrix_into_n(Rs,0,'below');
%                 FG_show_correlation_matrix(Rs_of_Artifact_ROIs);
%                 saveas(gcf,fullfile(root_first,'4_Snap_artifact_ROI_correlation_matrix.jpg'))
%                 if nargin~=0, close (gcf); end
%                 pause(0.01)  % release the memory to close the figure
% 
...
%                 saveas(gcf,fullfile(root_first,['5_Snap_Odd-Even -r ',num2str(r_odd_even,'%10.3f'),' -p ' ,num2str(p_odd_even,'%10.3f'), '.jpg']))
%                 if nargin~=0, close (gcf); end
%                 pause(0.01)  % release the memory to close the figure
% 
...
%                 saveas(gcf,fullfile(root_first,['6_Snap_r_related_pics_odd.jpg']))
%                 if nargin~=0, close (gcf); end
%                 pause(0.01)  % release the memory to close the figure
% 
% 
...
%                 saveas(gcf,fullfile(root_first,['7_Snap_r_related_pics_even.jpg']))
%                 if nargin~=0, close (gcf); end
%                 pause(0.01)  % release the memory to close the figure
% 
...
%                 saveas(gcf,fullfile(root_first,'8_Snap_r_diff_areas_odd_even.jpg'))
%                 if nargin~=0, close (gcf); end
%                 pause(0.01)  % release the memory to close the figure
...
%         background_only_imgs=strvcat(background_only_imgs,imgmat.fname);
        ...
        saveas(gcf,fullfile(root_first,['6_Snap_r_related_pics_all.jpg']))
        if nargin~=0, close (gcf); end
        pause(0.01)  % release the memory to close the figure
