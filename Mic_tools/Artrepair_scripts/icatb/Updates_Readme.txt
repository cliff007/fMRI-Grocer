GroupICAT v2.0e Updates (June 22, 2012):

Fixed bug in mancova toolbox when the covariates are entered manually in the covariates textbox. File icatb/icatb_mancovan_files/icatb_setup_mancovan_design is modified.

GroupICAT v2.0e Updates (June 15, 2012):

1. Component file paths are updated based on the location of the parameter file. The following files are modified:
	a. icatb/icatb_display_functions/icatb_component_viewer.m
	b. icatb/icatb_helper_functions/icatb_loadComp.m

GroupICAT v2.0e Updates (May 15, 2012):

Mean is removed for continuous covariates before computing interactions. File icatb/icatb_mancovan_files/icatb_mancovan_full_design.m is fixed.
